...
namespace sia::lts
{
struct XDisplayLocationCommandHandler : executor::Handler<detail::XDisplayLocation>
{
    explicit XDisplayLocationCommandHandler(std::shared_ptr<executor::NVTCommandExecutor> executor) : Handler(std::move(executor))
    {
    }
