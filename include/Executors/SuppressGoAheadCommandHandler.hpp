...
namespace sia::lts
{
struct SuppressGoAheadCommandHandler : executor::Handler<detail::SuppressGoAhead>
{
    explicit SuppressGoAheadCommandHandler(std::shared_ptr<executor::NVTCommandExecutor> executor) : Handler(std::move(executor))
    {
    }
