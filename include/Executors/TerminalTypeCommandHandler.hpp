...
namespace sia::lts
{
struct TerminalTypeCommandHandler : executor::Handler<detail::TerminalType>
{
    explicit TerminalTypeCommandHandler(std::shared_ptr<executor::NVTCommandExecutor> executor) : Handler(std::move(executor))
    {
    }
